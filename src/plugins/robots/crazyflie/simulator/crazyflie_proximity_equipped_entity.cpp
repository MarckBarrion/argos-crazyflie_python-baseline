...
namespace argos {
   ...
   CCrazyflieProximityEquippedEntity::SSensor::SSensor(const CVector3& c_offset,
    ...
    CCrazyflieProximityEquippedEntity::CCrazyflieProximityEquippedEntity(CComposableEntity* pc_parent) :
        CEntity(pc_parent) {
            Disable();
        }
    ...
    CCrazyflieProximityEquippedEntity::~CCrazyflieProximityEquippedEntity() {
    ...
    void CCrazyflieProximityEquippedEntity::Init(TConfigurationNode& t_tree) {
        try {
            /*
    ...
    void CCrazyflieProximityEquippedEntity::Enable() {
        CEntity::Enable();
    ...
    void CCrazyflieProximityEquippedEntity::Disable() {
        CEntity::Disable();
        for(size_t i = 0; i < m_tSensors.size(); ++i) {
    ...
    void CCrazyflieProximityEquippedEntity::AddSensor(const CVector3& c_offset,
                                                      const CVector3& c_direction,
                                                      Real f_range,
                                                      SAnchor& s_anchor) {
    ...
    void CCrazyflieProximityEquippedEntity::AddSensorRing(const CVector3& c_center,
                                                        Real f_radius,
   ...
   void CCrazyflieProximityEquippedEntity::AddSensorFan(const CVector3& c_center,
                                                     Real f_radius,
                                                     const CRadians& c_start_angle,
    ...
    REGISTER_STANDARD_SPACE_OPERATIONS_ON_ENTITY(CCrazyflieProximityEquippedEntity);
