...
namespace argos {
    ...
    CCrazyflieGroundSensorEquippedEntity::CCrazyflieGroundSensorEquippedEntity(CComposableEntity* pc_parent) :
        CEntity(pc_parent) {
        Disable();
    }
    ...
    CCrazyflieGroundSensorEquippedEntity::~CCrazyflieGroundSensorEquippedEntity() {
   ...
   /****************************************/
    ...
    void CCrazyflieGroundSensorEquippedEntity::Init(TConfigurationNode& t_tree) {
        try {
            /*
    ...
    void CCrazyflieGroundSensorEquippedEntity::Enable() {
        CEntity::Enable();
    ...
    void CCrazyflieGroundSensorEquippedEntity::Disable() {
        CEntity::Disable();
        for(size_t i = 0; i < m_tSensors.size(); ++i) {
    ...
    void CCrazyflieGroundSensorEquippedEntity::AddSensor(const CVector2& c_offset,
                                                ESensorType e_type,
                                                SAnchor& s_anchor) {
    ...
    void CCrazyflieGroundSensorEquippedEntity::AddSensorRing(const CVector2& c_center,
                                                        Real f_radius,
    ...
    CCrazyflieGroundSensorEquippedEntity::ESensorType CCrazyflieGroundSensorEquippedEntity::ParseType(const std::string& str_type) const {
    ...
    REGISTER_STANDARD_SPACE_OPERATIONS_ON_ENTITY(CCrazyflieGroundSensorEquippedEntity);
